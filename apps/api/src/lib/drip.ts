...
const D1: Msg = {
  ...
  titleAr: 'Your first session is ~10 minutes 💪',
  body: 'Your plan is ready and waiting. One short session today is all it takes to start.',
  bodyAr: 'Your plan is ready and waiting. One short session today is all it takes to start.',
  url: '/',
};
const D2: Msg = {
...
const D3: Msg = {
  ...
  titleAr: 'Day 3: your first badge is one workout away 🔥',
  body: 'Train today and your streak starts counting. Small steps, every day — that is the whole secret.',
  bodyAr: 'Train today and your streak starts counting. Small steps, every day — that is the whole secret.',
  url: '/',
};
...
export async function runConnectionNudge(): Promise<string> {
  ...
  for (const u of candidates) {
    ...
    await notifyUser(u.id, {
      ...
      titleAr: 'Training together sticks 👯',
      body: 'Invite a friend as your workout buddy, or join this week’s live group session — people who train together keep going.',
      bodyAr: 'Invite a friend as your workout buddy, or join this week’s live group session — people who train together keep going.',
      url: '/buddies',
      type: 'general',
    }).catch(() => {});
    sent++;
