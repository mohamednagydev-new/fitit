...
import { adminContentHealthRouter } from './routes/adminContentHealth';
import { adminIntegrityRouter } from './routes/adminIntegrity';
...
app.use('/api/admin-content-health', adminContentHealthRouter);
