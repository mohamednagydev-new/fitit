...
const CANNED: { label: string; text: string }[] = [
  ...
  },
  {
    ...
    text: "To get workout reminders and replies, enable notifications: open your Profile → Settings and turn on push notifications, then allow them when your browser or phone asks. If you previously blocked them, re-enable notifications for the app in your browser/site settings.",
  },
  {
